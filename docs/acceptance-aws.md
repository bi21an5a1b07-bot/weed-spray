...
Do not treat GPS / `vehicle_local_position.z` as AGL. Do not invent rangefinder PX4 params to fake a green table. Exit `0` only with a real rangefinder in the 0.24–0.32 m band (hardware or a Gazebo lidar profile) — **not** default compose.
