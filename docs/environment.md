...
| `WEED_LIDAR_MOUNT_DOWN_M` | `0.0` | Belly lidar below CG (metres). NED hover down = `-(hover_agl_m + this)` so lidar, not CG, is at hover AGL. `make backend-gz` sets `0.28` (gz overlay z=-0.28) |
